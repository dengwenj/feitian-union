...
import com.lcodecore.tkrefreshlayout.views.FTNestedScrollView;
...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if (view instanceof FTNestedScrollView) return isFTNestedScrollViewToBottom((FTNestedScrollView) view);
        if (view instanceof ViewGroup) return isViewGroupToBottom((ViewGroup) view);
        return false;
    }

    private static boolean isFTNestedScrollViewToBottom(FTNestedScrollView view) {
